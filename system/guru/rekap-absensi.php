				...
				<header class="box-typical-header">
					<div class="tbl-row">
					 	<div class="tbl-cell tbl-cell-title">
					  		<div align="center">
								<h5>DATA HASIL REKAP KELAS : <?php echo $nm_kelas=isset($_POST['nm_kelas']); ?></h5>
								<h7>( Tanggal : <?php echo $tgl1=isset($_POST['tgl1']); ?> - <?php echo $tgl2=isset($_POST['tgl2']); ?> )</h7> 
							</div>
						</div>
					</div>
				</header>
