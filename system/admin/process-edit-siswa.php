...
if (empty($gambar))
{
	...
	$query = mysql_query("UPDATE siswa SET nis='$nis', nama='$nama', nm_kelas='$nm_kelas', jns_kel='$jns_kel', tmpt_lahir='$tmpt_lahir', tgl_lahir='$tgl_lahir', alamat='$alamat' where id_siswa='$id_siswa'")
		or die (mysql_error());
...
{ 
	//update data di database sesuai id_siswa
	$query = mysql_query("update siswa set nis='$nis', nama='$nama', nm_kelas='$nm_kelas', jns_kel='$jns_kel', tmpt_lahir='$tmpt_lahir', tgl_lahir='$tgl_lahir', alamat='$alamat', foto='$foto' where id_siswa='$id_siswa'")
		or die (mysql_error());
	header('location:page.php?data-semua-siswa&message=edit-success');   
