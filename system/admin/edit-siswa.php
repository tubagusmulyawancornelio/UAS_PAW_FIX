					...
					<div class="row">  
						<form id="form-insert" name="form-insert" action="page.php?process-edit-siswa" enctype="multipart/form-data" method="POST">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<label class="color-blue-grey-lighter" for="insert-nis"><i class="font-icon font-icon-contacts"></i> NIM </label>
									<div class="form-control-wrapper">
										<input id="insert-nis" value="<?php echo $data['nis']; ?>" class="form-control" name="nis" placeholder="NIM Siswa" type="text"
										data-validation="[L>=1]"
										data-validation-message="NIM Siswa Tidak Boleh Kosong">
									</div>
								</div>
